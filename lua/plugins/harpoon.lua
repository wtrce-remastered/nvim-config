return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>ha", function() harpoon:list():replace_at(11) end)
        vim.keymap.set("n", "<leader>he", function() harpoon:list():replace_at(12) end)
        vim.keymap.set("n", "<leader>hi", function() harpoon:list():replace_at(13) end)

        vim.keymap.set("n", "<C-a>", function() harpoon:list():select(11) end)
        vim.keymap.set("n", "<C-e>", function() harpoon:list():select(12) end)
        vim.keymap.set("n", "<C-i>", function() harpoon:list():select(13) end)
        ...
        vim.keymap.set("n", "<leader>s0", function() harpoon:list():replace_at(0) end)
